 ...
 * @returns
 */
export default function StoreAsync(key, config) {
    var sset = config && isFunction(config === null || config === void 0 ? void 0 : config.set) ? config.set : defaultSet;
    var sget = config && isFunction(config === null || config === void 0 ? void 0 : config.get) ? config.get : defaultGet;
    var sremove = config && isFunction(config === null || config === void 0 ? void 0 : config.remove) ? config.remove : defaultRemove;
    var storeObj = {
